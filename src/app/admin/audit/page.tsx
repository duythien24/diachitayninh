...
import { Activity, FileClock, KeyRound, Library, UserCircle } from "lucide-react";
        ...
        <div className="divide-y divide-ink/8">
          {logs.length ? (
            ...
            <div className="p-8 text-center text-sm text-ink/60">
              Chưa có lịch sử thao tác. Sau khi chạy SQL và thực hiện thêm/sửa/xóa, log sẽ hiển thị tại đây.
            </div>
          )}
        </div>
      </section>
