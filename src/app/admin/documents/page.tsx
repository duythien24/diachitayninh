    ...
    <PageShell>
        ...
        {documentGroups.map((group) => {
          ...
          return (
            <Link
              ...
              className={cn(
                "flex h-full flex-col rounded border p-5 shadow-sm transition hover:-translate-y-0.5 hover:shadow-soft",
      ...
      <section className="mt-8">
        <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <p className="text-sm font-semibold uppercase text-lacquer">{activeGroupInfo.title}</p>
